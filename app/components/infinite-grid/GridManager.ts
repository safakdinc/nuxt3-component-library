...
import {
  generateForegroundTexture,
  generateBackgroundTexture,
  updateAllVideoTextures,
} from "./createTexture";
...
export class GridManager {
  ...
  /**
   * Updates all video textures in the grid
   * Should be called in the main render loop to keep video content current
   */
