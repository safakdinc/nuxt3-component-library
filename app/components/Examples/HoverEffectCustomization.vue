<template>
  <div class="w-full h-full justify-center flex flex-col py-4 lg:p-[64px] space-y-8">
    ...
    <div class="w-full max-w-4xl mx-auto bg-[var(--background-fade)] p-6 rounded-lg">
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div>
          ...
          <input v-model.number="customization.borderIntensity" type="range" min="0" max="1" step="0.1" class="w-full" />
        ...
        <div>
          ...
          <input v-model.number="customization.glowIntensity" type="range" min="0" max="0.2" step="0.01" class="w-full" />
        ...
        <div>
          ...
          <input v-model.number="customization.animationSpeed" type="range" min="0.1" max="1" step="0.1" class="w-full" />
        ...
        <div>
          ...
          <input v-model.number="customization.borderRadius" type="range" min="0" max="30" step="2" class="w-full" />
        ...
        <div>
          ...
          <input v-model.number="customization.effectSize" type="range" min="300" max="800" step="50" class="w-full" />
        ...
        <div class="flex items-end">
          <button @click="resetCustomization" class="w-full px-4 py-2 bg-gray-600 hover:bg-gray-700 text-white rounded transition-colors">
            Reset
          </button>
        </div>
      </div>
    ...
    <!-- Hover Effect Demo -->
    <HoverContainer :items="frameworks" :item-min-width="220" :item-max-width="320" :row-padding="16" :col-padding="16">
      <template #default="{ item, index }">
        <HoverCard
          :customization="customization"
          class="aspect-square p-4 flex flex-col items-center justify-center bg-[var(--background-fade)] h-full w-full">
