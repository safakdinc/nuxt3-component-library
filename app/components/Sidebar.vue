...
const windowSmall = computed(() => width.value < 768);

// The formatTitle function is not strictly needed anymore as titles come directly from navigation data
...
.group-title-link {
  color: var(--text-color); // Or whatever color you want for group titles that are links
