<template>
  <div class="w-full justify-center flex p-[64px]">
    <HoverContainer class="w-full flex flex-wrap gap-[8px]">
      <HoverCard
        v-for="(framework, index) in frameworks"
        :key="index"
        class="aspect-square p-4 flex flex-col items-center justify-center bg-[var(--background-fade)] rounded-lg shadow-lg transform transition-transform duration-300 hover:scale-105"
