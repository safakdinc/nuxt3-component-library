    ...
    <BorderGradient background="rgba(15, 23, 42, 0.8)" class="flex items-center justify-center" wrapperClass="custom-wrapper">
      <div class="w-[300px] h-[400px] flex flex-col justify-between p-6">
        ...
        <div class="flex justify-between items-center">
          <span class="text-yellow-400 text-lg">$199.99</span>
          <button class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded">Buy Now</button>
        </div>
      </div>
    </BorderGradient>
    <BorderGradient
      ...
      <div class="w-[300px] h-[400px] flex flex-col justify-between p-6">
        ...
        <div class="flex justify-between items-center">
          <span class="text-orange-500 text-lg">$149.99</span>
          <button class="bg-pink-400 hover:bg-pink-500 text-white px-4 py-2 rounded">Add to Cart</button>
        </div>
      </div>
    </BorderGradient>
  </div>
