<template>
  <div ref="container">
    <div
      ...
      class="flex gap-[16px] max-w-full w-full items-center cursor-pointer rounded-xl relative p-2
        originalBackgroundSlot group"
    >
      <div
        :class="
          twMerge(
      ...
      <div class="w-[56px] h-[56px] aspect-square rounded-lg overflow-hidden originalImageSlot">
        <img
          :src="props.cardInfo.src"
          class="w-full h-full object-cover object-center image rounded-t-[inherit]"
        />
      </div>
      <div class="flex-1 flex originalTitleSlot">
        <div class="flex-1 flex items-center title z-[100] relative">
          <div class="flex-1 flex flex-col justify-center w-full">
            ...
            <div class="text-[10px] lg:text-[12px] xl:text-[14px]" style="color: var(--text-gray)">
          ...
          <button
            ...
            "
          >
            <div class="text-[10px] lg:text-[12px] xl:text-[14px]">
      ...
      <div v-show="open" class="w-full h-full fixed top-0 left-0 z-[1001]">
        <div class="w-full h-full relative flex justify-center items-center z-[100]">
          <div
            ...
            class="absolute top-0 left-0 bg-black w-full h-full opacity-50 z-[-1]"
          ></div>
          <div class="rounded-xl background-slot relative w-[95%] max-w-[500px]">
            <div
              class="h-[80vh] w-full flex flex-col items-start gap-[16px] customScroll
                overflow-y-auto"
            >
...
function openExpandable() {
  open.value = true;
  container.value.querySelector(".title-slot").style.height =
    container.value.querySelector(".title").offsetHeight + "px";
