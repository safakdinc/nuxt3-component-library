    ...
    <div class="container flex relative">
        ...
        <div class="top-1 -ml-[11px] -mt-3">
          ...
          >
            <path
              ...
              fill="rgba(254, 128, 0, 1)"
            ></path>
          </svg>
        </div>
        <div
          class="w-[2px] bg-gradient-to-b from-[#fe8000] to-transparent h-[170px] line"
          style="opacity: 1"
        ></div>
        <div
          class="h-3 w-3 rounded-full z-[100] circle"
          style="background-color: #fe8000; transform: translateX(-50%) translateY(50%)"
        ></div>
      </div>
      <div class="absolute flex-col -mt-1 flex w-fit justify-start text-nowrap sm:-mt-2">
        ...
        <div class="flex h-fit flex-col gap-2 pl-4" style="opacity: 1">
          ...
          <div
            v-for="text in props.texts"
            class="font-sans-md flex items-center gap-2 leading-none paragraph"
            style="opacity: 1"
          >
            <svg
              width="7"
